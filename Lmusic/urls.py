...
urlpatterns = [
    ...
    url(r'^video_detail/(?P<video_id>\d+)/$',
    ...
    url(r'^singer_detail/(?P<singer_id>\d+)/$',
        SingerDetailView.as_view(), name="singer_detail"),
    url('^modify_pwd/$', ModifyPwdView.as_view(), name="modify_pwd"),
    url(r'^music_type/(?P<music_type_id>\d+)/$',
        MusicTypeDetailView.as_view(), name="music_with_type"),
    url('^update_profile/$',
    ...
    url(r'^music_play/(?P<music_id>\d+)/$',
        MusicPlayView.as_view(), name="music_play"),
